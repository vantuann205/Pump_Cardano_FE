...
const MOCK_HOLDERS = [
    { rank: 1, address: 'addr1...3f2', percent: '12.50%', value: '$5,240', tag: 'DEV' },
    { rank: 2, address: 'MinSwap LP', percent: '10.00%', value: '$4,192', tag: 'BONDING CURVE' },
    { rank: 3, address: 'addr1...9a1', percent: '4.20%', value: '$1,760' },
    { rank: 4, address: 'addr1...11z', percent: '1.50%', value: '$628' },
    { rank: 5, address: 'SundaeSwap', percent: '0.90%', value: '$377' },
];
